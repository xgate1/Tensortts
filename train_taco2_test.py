...
class Tacotron2Trainer(Seq2SeqBasedTrainer):
    ...
    def compute_per_example_losses(self, batch, outputs):
        ...
        # batch : train_dataset.element_spec, models tacotron2 decoder_outputs 2개가 input
        print('-'*100)
        print(batch["mel_gts"])
...
def main():
    ...
    parser.add_argument(
        "--train-dir",
        default='D:\Face\Tensor_ver\data\moon\\train',
        type=str,
        required=False,
    ...
    parser.add_argument(
        "--dev-dir",
        default='D:\Face\Tensor_ver\data\moon\\valid',
        type=str,
        required=False,
    ...
    parser.add_argument(
        "--outdir", default='D:\Face\Tensor_ver\\train_model',type=str, required=False, help="directory to save checkpoints."
    )
    parser.add_argument(
        "--config", default='D:\Face\Tensor_ver\TensorflowTTS-master\examples\\tacotron2\conf\\tacotron2.v1.yaml',type=str, required=False, help="yaml format configuration file."
    )
    # chechk point (to load)
    parser.add_argument(
        "--resume",
        default="",
        type=str,
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--train-dir",
    #     # default=['D:\Face\Tensor_ver\data\moon\\train','D:\Face\Tensor_ver\data\son\\train'],
    #     default='D:\Face\Tensor_ver\data\moon\\train',
    #     type=str,
    #     required=False,
    #     help="directory including training data. ",
    ...
    # parser.add_argument(
    #     "--dev-dir",
    #     # default=['D:\Face\Tensor_ver\data\moon\\valid','D:\Face\Tensor_ver\data\son\\valid'],
    #     default='D:\Face\Tensor_ver\data\moon\\valid',
    #     type=str,
    #     required=False,
    #     help="directory including development data. ",
    ...
    # )
    # parser.add_argument(
    #     "--outdir", default='D:\Face\Tensor_ver\\train_model', type=str, required=False,
    #     help="directory to save checkpoints."
    # )
    # parser.add_argument(
    #     "--config", default='D:\Face\Tensor_ver\TensorflowTTS-master\examples\\tacotron2\conf\\tacotron2.v1.yaml',
    #     type=str, required=False, help="yaml format configuration file."
    # )
    # # chechk point (to load)
    # parser.add_argument(
    #     "--resume",
    ...
    traindir= os.path.join('D:\Face\Tensor_ver\data', "**\\train")  # glob_path = os.path.join('D:\Face\Tensor_ver\data\**\\train', "*.npy")
    devdir = os.path.join('D:\Face\Tensor_ver\data', "**\\valid")
    usenorm=1
    outdir='D:\Face\Tensor_ver\\train_model'
    configL='D:\Face\Tensor_ver\TensorflowTTS-master\examples\\tacotron2\conf\\tacotron2.v1.yaml'
    resume=''
    verbose=1
    mixed_precision=0
    #
    ...
    # load and save config
    with open(configL) as f:
        config = yaml.load(f, Loader=yaml.Loader)
    config["version"] = tensorflow_tts.__version__

    config["--train-dir"]=traindir
    config["--dev-dir"]=devdir
    config["--use-norm"]=usenorm
    config["outdir"]=outdir
    config["--outdir"]=outdir
    config["--config"]=configL
